...
export const RegisterForm = () => {
    ...
    return (
        <CardWrapper headLabel="Create new account" backButtonHref="/auth/login" backButtonLabel="Already have an account?" showSocial>
            <Form {...form}>
                    ...
                    <FormField 
                        ...
                        render={({ field }) => (
                            <FormItem>
                                ...
                                <FormControl>
                                    <Input disabled={isPanding} {...field} placeholder="john Doe" type="text" />
                                </FormControl>
                                <FormMessage />
                            </FormItem>
                        )}
